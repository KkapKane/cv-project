...
function PersonalInfo({ handlePersonal, genData, handleChange, setExp, onSubmit, handleSubmit, register, onSubmitEdu, handleSubmit2, register2, handleChange2 }) {
    ...
    return (
        ...
        <div className="personalContainer">
            ...
            <input type="text" id="name" value={genData.name} onChange={handlePersonal} maxLength="20" />
            <input type="text" placeholder="Last name" id="last" value={genData.last} onChange={handlePersonal} maxLength="20" />
            ...
            <input type="file" id="imageinput" accept="image/png, image/jpg" onChange={handleChange2} />
